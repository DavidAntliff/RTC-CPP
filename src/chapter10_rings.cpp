...
int main(int argc, char * argv[]) {
    ...
    auto floor_pattern = ring_pattern(red, white);
    ...
    auto middle_pattern = ring_pattern(blue, white);
    ...
    auto right_pattern = ring_pattern(green, black);
    ...
    auto left_pattern = ring_pattern(yellow, black);
